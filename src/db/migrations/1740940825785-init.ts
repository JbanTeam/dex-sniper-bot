...
export class Init1740940825785 implements MigrationInterface {
  name = 'Init1740940825785';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "user_token" ("id" SERIAL NOT NULL, "address" character varying NOT NULL, "network" character varying NOT NULL DEFAULT 'BSC', "userId" integer, CONSTRAINT "PK_48cb6b5c20faa63157b3c1baf7f" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "user" ("id" SERIAL NOT NULL, "chatId" integer NOT NULL, "telegramUserId" integer NOT NULL, CONSTRAINT "UQ_1cfa1784ac9e67d4be782f4e5b8" UNIQUE ("chatId"), CONSTRAINT "UQ_01729d9465105fe07244458a523" UNIQUE ("telegramUserId"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
