...
export class Init1747406939183 implements MigrationInterface {
  name = 'Init1747406939183';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "replication" ("id" SERIAL NOT NULL, "network" character varying NOT NULL DEFAULT 'BSC', "buy" integer NOT NULL DEFAULT '0', "sell" integer NOT NULL DEFAULT '0', "userId" integer, "subscriptionId" integer, "tokenId" integer, CONSTRAINT "PK_7c97aba530a59d827a5b118bdaf" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
